...
> [!TIP]
>
> - Microsoft 365 Copilot의 Agent Builder에 대해 더 알아보려면 [Copilot Developer Camp: Lab MAB1 - Build your first agent](https://microsoft.github.io/copilot-camp/pages/make/agent-builder/01-first-agent/)를 참고하세요.
> - Microsoft 365 Copilot에서 Agent Builder를 넘어서는 프로 개발에 대해서는 [Copilot Developer Camp: Extend Microsoft 365 Copilot](https://microsoft.github.io/copilot-camp/pages/extend-m365-copilot/)을 참고하세요.
...
- Maker는 Copilot Studio 환경에서 생성 권한 및 접근 권한이 있어야 합니다.

> [!NOTE] 라이선스 참고
> 이 랩에서는 도구로서 Prompt를 추가하는 단계까지 안내합니다. 다음 레슨에서 지식 소스 추가 및 다른 도구를 더 깊게 다룹니다. 학습을 위해 단순하게 시작합니다 😊
>
> Copilot Studio에서 구축한 선언형 에이전트를 Microsoft 365 Copilot에 게시하는 데에는 Microsoft 365 Copilot 사용자 라이선스가 필요하지 않습니다. 그러나 Microsoft 365 Copilot에서 _게시된 선언형 에이전트를 사용하는_ **사용자**에게는 Microsoft 365 Copilot 사용자 라이선스가 필요합니다.
